...
titleText.Text = "VOID HUB | FPS: 0 | PING: 0"
...
task.spawn(function()
    while true do
        titleText.Text = string.format("VOID HUB | FPS: %d | PING: %d", fps, ping)
        task.wait(0.5)
    end
end)
...
local function createSwitch(parent, labelText, yPos, showOutline)
    ...
    container.Size = UDim2.new(1, -20, 0, 50) -- Increased from 35 to 50 for mobile
    ...
    label.TextSize = 15 -- Increased from 13 to 15
    label.TextColor3 = COLOR_WHITE
    label.TextXAlignment = Enum.TextXAlignment.Left
    label.Parent = container
    
    local switchCont = Instance.new("Frame")
    switchCont.Size = UDim2.new(0, 60, 0, 30) -- Increased from 50x25 to 60x30
    switchCont.Position = UDim2.new(1, -70, 0.5, -15) -- Adjusted position
    ...
    toggle.Size = UDim2.new(0, 26, 0, 26) -- Increased from 21x21 to 26x26
